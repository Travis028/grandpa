...
export default function ProgramPDF() {
  ...
  // Page 1: Cover (Watermark removed, white background)
  const PageCover = () => (
    <div className="pdf-page-content pdf-page-center pdf-cover" style={{ background: '#fff' }}>
  ...
  // Page 2: Order of Service (Watermark removed)
  const PageProgram = () => (
    <div className="pdf-page-content" style={{ background: '#fff' }}>
  ...
  const PageGallery1 = () => (
    <div className="pdf-page-content pdf-page-center" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#fff' }}>
  ...
  const PageBackCover = () => (
    <div className="pdf-page-content pdf-page-center" style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center', alignItems: 'center', background: '#fff' }}>
