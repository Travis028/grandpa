  ...
  const PageStory = () => (
    <div className="pdf-page-content">
      ...
      <div className="pdf-content-relative">
        ...
        <div style={{ fontSize: '0.68rem', lineHeight: '1.20', columnCount: 2, columnGap: '20px', textAlign: 'justify' }}>
          <p style={{ margin: '0 0 5px 0', fontWeight: 'bold' }}>A Celebration of the Life of Apollo Josiah Fizvalentine Owino Awidhi</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>A Precious Gift to the World</h4>
          <p style={{ margin: '0 0 5px 0' }}>On April 23, 1952, a remarkable soul was ushered into this world, Apollo Josiah Fizvalentine Owino Awidhi, the last-born son of the late Timotheo Awidhi Nyandere and the late Isdora Kiti Awidhi. From his earliest days, it was evident that Apollo was destined for greatness, blessed with an insatiable curiosity and an enduring spirit that would later define his extraordinary life.</p>
          <p style={{ margin: '0 0 5px 0' }}>He was a cherished brother to the late Ismael Onyango Awidhi, the late Mary Mwai, the late Annah Adhiambo Odoyo, the late Samuel Awiti Awidhi, the late Nerea Odira, and the late Hesbon Odero Awidhi. Together, they formed a close-knit family bound by love, mutual respect, and shared memories that would last a lifetime.</p>
          <p style={{ margin: '0 0 5px 0' }}>His sisters-in-law, whom he held in high regard, include the late Jane Odero, Caren Onyango, Zilpah Awiti, and Silpa Onyango. They were not merely in-laws but cherished members of his extended family, and he valued their presence and contribution to the family bond.</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>A Scholarly Foundation</h4>
          <p style={{ margin: '0 0 5px 0' }}>Apollo's educational journey began with humble yet significant steps. He commenced his early schooling at Kwoyo Kodolo before proceeding to Ngere Primary School, where he successfully sat for his Certificate of Primary Education in 1970. His academic prowess earned him a place at Isebania High School, where he distinguished himself and completed his East African Certificate in 1974.</p>
          <p style={{ margin: '0 0 5px 0' }}>Driven by a profound passion for imparting knowledge and shaping futures, he enrolled at Kamwenja Teachers College in 1975. Upon graduating in May 1976 with a P1 teaching certificate, Apollo was equipped not merely with qualifications but with a vocation—a calling to nurture and enlighten young minds.</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>An Illustrious Career in Education</h4>
          <p style={{ margin: '0 0 5px 0' }}>Apollo's professional odyssey was one of unwavering dedication, resilience, and transformative leadership. His teaching career commenced in Nyatike Sub-County, where the Teachers Service Commission posted him to Otho Primary School and subsequently to Mariba Primary School. Between 1977 and 1979, he labored diligently, instilling knowledge and discipline in his pupils.</p>
          ...
          <p style={{ margin: '0 0 5px 0' }}>In 1985, Apollo took on greater responsibilities when he was posted to Kuna Primary School and later to Tuk Jowi Primary School. For eight years, from 1985 to 1992, he served with distinction as Head Teacher, demonstrating exceptional administrative acumen and a visionary approach to education. His leadership was characterized by unwavering integrity, profound empathy, and an unyielding commitment to academic excellence.</p>
          <p style={{ margin: '0 0 5px 0' }}>In 1993, he was transferred to Saria Primary School, where he assumed the role of Head of Institution. For fourteen years, until his retirement in 2007, Apollo steered the school with remarkable foresight and dedication. Under his stewardship, the institution flourished, and countless students were transformed into responsible, educated citizens. His career spanned over three decades—a testament to his enduring passion for education and his profound impact on generations of learners.</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>A Devoted Husband and Loving Father</h4>
          <p style={{ margin: '0 0 5px 0' }}>Beyond his professional achievements, Apollo was first and foremost a family man. On April 25, 1975, he entered into holy matrimony with his beloved wife, Mama Joyce Aoko Owino. Their union, blessed with enduring love, mutual respect, and unwavering support, became a beacon of inspiration to all who knew them.</p>
          <p style={{ margin: '0 0 5px 0' }}>God blessed their marriage with several wonderful children: Pastor Evans Owino, The late Elly Owino, Hellen Okello, Joan Atieno, The late Victor Owino, Timothy Apollo, Jeph Apollo, Beryle Mercy Andrew, and Charles Apollo.</p>
          <p style={{ margin: '0 0 5px 0' }}>Apollo's heart extended generously to his daughters-in-law, whom he cherished as his own. They include the late Milca Aoko, Eunice Odhiambo, Nancy Otieno, Roselyne Jeph, and Lillian Were. He was a pillar of strength, a wellspring of wisdom, and an embodiment of unconditional love to his entire family.</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>A Legacy of Love and Inspiration</h4>
          <p style={{ margin: '0 0 5px 0' }}>Apollo Josiah Fizvalentine Owino Awidhi lived a life of profound purpose. He was a mentor, a leader, a confidant, and a steadfast patriarch. His journey was marked not by the adversities he encountered but by the triumphs he achieved and the lives he transformed along the way.</p>
          ...
          <p style={{ margin: '0 0 5px 0' }}>On the tranquil morning of June 1, 2026, at 04:00 hours, the Lord in His infinite wisdom called His faithful servant home. Apollo transitioned peacefully, surrounded by the warmth of prayers and the love of his devoted family. Though he has departed from our physical presence, his spirit, his teachings, and his boundless love remain eternally etched in our hearts.</p>
          
          <h4 style={{ margin: '6px 0 3px 0', color: 'var(--primary)', fontSize: '0.75rem' }}>Farewell to a Gentle Giant</h4>
          <p style={{ margin: '0 0 5px 0' }}>As we bid farewell to this extraordinary man, we do so with gratitude rather than sorrow. We are thankful for the years we shared, the lessons he imparted, and the indelible legacy he leaves behind. His life was a masterpiece of service, sacrifice, and steadfast devotion.</p>
          <p style={{ margin: '0 0 5px 0' }}>Rest now, dear Apollo. Your work on earth is complete. Your family is strong, your legacy is secure, and your memory will forever be cherished. May your soul find eternal peace in the presence of your Creator.</p>
